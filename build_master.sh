...
export CROSS_COMPILE=/home/aptiva/dev/android/tools/toolchains/linaro4.7/bin/arm-eabi-
...
if [ $ADD_KTWEAKER = 'Y' ]; then
	cp /home/aptiva/dev/android/kernels/KT/com.ktoonsez.KTweaker.apk $PACKAGEDIR/system/app/com.ktoonsez.KTweaker.apk
fi;
